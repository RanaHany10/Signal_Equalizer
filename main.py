...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def handle_slider_change(self):
        ...
        modes_dict = {
            ...
            "Medical": {
                self.verticalSlider_1: [51, 60],  # Arrythmia 1 (Aflutter)
                self.verticalSlider_2: [120, 200],  # Arrythmia 2 (VT)
                self.verticalSlider_3: [1101, 1200],  # Arrythmia 3 (AF)
            }
        }
        # get current mode
    ...
    def fourier_transform(self, audio_file, sample_rate):
        ...
        print("min_freq: ", min(frequency))
        print("max_freq: ", max(frequency))
